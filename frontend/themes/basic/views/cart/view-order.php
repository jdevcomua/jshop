...
<div class="f-s_0 title-order-view without-crumbs">
    <div class="frame-title">
        <h1 class="title"><?php echo \Yii::t('app', 'Заказ'); ?> №:<span
                class="number-order"><?php echo $order->id; ?></span></h1>
    </div>
</div>
...
<div class="left-order">
    ...
    <table class="table-info-order" style="font-size: 13px;">
        ...
        <tr>
            ...
            <td>
                <span
                    class="status-pay <?= ($order->payment_status == 'Не оплачен') ? 'not-paid' : 'paid'; ?>">
                ...
                <table class="table-order table-order-view">
                                ...
                                <span class="frame-prices">
                                    <span class="current-prices f-s_0">
                                        <span class="price-new">
                                            <span class="price"><?= $orderItem->sum; ?></span>
                                        </span> 
                                    </span>
                                </span>
                            </td>
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <div class="f_r">
                                <span
                                    class="text-el s-t"><?php echo \Yii::t('app', 'согласно тарифам перевозчиков'); ?></span>
                            </div>
                        </td>
                    </tr>
                    </tfoot>
