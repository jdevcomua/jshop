                                        ...
                                        <ul style="font-size: 12px; margin-left: 0; "
                                            ...
                                            <?php } else {
                                                foreach ($list->getWishes()->all() as $wish) {
                                                    ...
                                                    $item = $wish->item;
                                                    ?>
                                                    <li id="wish-<?php echo $wish->id; ?>"
                                                        class="globalFrameProduct to-cart" data-pos="top">
                                                        ...
                                                        <div class="funcs-buttons-WL-item">
                                                            <div class="btn-remove-item-wl">
                                                                <button type="button"
                                                                        id="remove-<?php echo $wish->id ?>"
                                                                        class="btnRemoveItem isDrop"
                                                                        onclick="removeItemFromWishList(<?php echo $wish->id ?>)">
