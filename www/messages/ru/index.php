...
return array(
    ...
    'Account Dashboard' => 'Домашняя страница аккаунта',
    ...
    'Register for use Wish List'=>'Зарегистрируйтесь для использования Списка желаний',
    ...
    'Keywords (comma separated)'=>'Keywords (через запятую)',
    'New URL(Фраза которая находиться после номера элемента)'=>'Новый URL (Фраза, которая находится после номера элемента)',
