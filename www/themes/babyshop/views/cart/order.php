                ...
                <ol class="one-page-checkout" id="checkoutSteps">
                    <li id="opc-address" class="section allow active">
                        <div class="step-title"> <span class="number">1</span>
                            <h3 class="one_page_heading"> Address Information</h3>
                        </div>
                        <div id="checkout-step-address" class="step a-item" style="">
                            <fieldset class="group-select">
                                    ...
                                    <li id="billing-new-address-form">
                                        <fieldset>
                                            <ul>
                                                <li class="fields">
                                                    <div class="customer-name">
                                                        <div class="input-box name-firstname">
                                                            <label for="orders-name">Name and Surname<span class="required">*</span></label>
                                                ...
                                                <li class="fields">
                                                    <div class="customer-phone">
                                                        <div class="input-box phone">
                                                            <label for="orders-phone">Phone number<span class="required">*</span></label>
                                                            <div class="input-box1">
                                                ...
                                                <li class="fields">
                                                    <div class="input-box">
                                                        <label for="orders-address">Address - <?= $model->address?><span class="required">*</span></label>
                                                ...
                                                <li class="fields">
                                                    <div class="input-box">
                                                        <label for="orders-mail">Mail</label>
                                                ...
                                                <li class="fields">
                                                    <div class="input-box">
                                                        <label for="orders-address">Comment</label>
                                ...
                                <div class="buttons-set" id="billing-buttons-container">
                                    ...
                                    <button id="submit_step_one" type="button" title="Continue" class="button continue"><span>Continue</span></button>
                        ...
                        <div id="checkout-step-review" class="step a-item" style="display: none;">
                            <div class="order-review" id="checkout-review-load">
                                ...
                                <div class="buttons-set" id="billing-buttons-container">
                                    ...
                                    <button id="submit" type="submit" title="Submit" class="button send"><span>Submit</span></button>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="block-content">
                            <dl>
                                <div id="billing-progress-opcheckout">
                                    <dt id="address_view"> Address: <?= $model->address ?> </dt>
                                </div>
