                        ...
                        <div id="tab-<?php echo $category_id; ?>" class="items-carousel" >
                            ...
                            <div class="right-compare horizontal-carousel">
                                ...
                                <span class="photo-block"><span class="helper"></span><img
                                        src="<?php echo array_shift($item->getImageUrls()); ?>"></span>
                                                        ...
                                                        <div class="description">
                                                            ...
                                                            <div class="frame-prices-buttons">
                                                                ...
                                                                <button type="button" class="icon_times deleteFromCompare" onclick="deleteFromCompareList(<?php echo $item->id?>, $(this))"></button>
                            ...
                            <div class="scrollNSP jScrollPane" style="overflow: hidden; width: 750px; top: 273px; padding: 0px;"><div class="jspContainer" style="width: 750px; height: 16px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 750px;"><div style="width:500px;"></div></div></div></div></div>
                        <?php } ?>
                    </div>
