...
<li class="item ">
    ...
    <div class="product-shop">
        ...
        <div class="actions">
            ...
            <span class="add-to-links"> <a title="Add to Wishlist" data-item-id="<?= $model->id ?>"  onclick="addToWishList(<?= $model->id ?>,this)" class="button link-wishlist <?=!empty($wishList) ? in_array($model->id,$wishList)?'in-wish-list':'':''?>" href=""><span><?= Yii::t('app','Add to Wishlist')?></span></a> </span> </div>
    </div>
</li>
