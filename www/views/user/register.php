                        ...
                        <ul class="form-list">
                            <li>
                                <?= $form->field($model, 'email')
                                    ->textInput(['class' => 'input-box input-text required-entry'])
                                    ->label(Yii::t('app/model','Адрес электронной почты').'<em class="required">*</em>')?>
                            </li>
                            <li>
                                <?= $form->field($model, 'password')
                                    ->passwordInput(['class' => 'input-box input-text required-entry'])
